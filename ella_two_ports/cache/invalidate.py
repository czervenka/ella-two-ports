...
def load_cache_deleter(cache_deleter=None):
    ...
    if cache_deleter is None:
        cache_deleter = 'ella_two_ports.cache.invalidate.CacheDeleterCache'
...
class CacheDeleterCache(object):
    ...
    def _get_key(obj):
        ...
        return md5(repr(('ella_two_ports.cache.invalidate.CacheDeleterCache', obj.__class__, obj.pk,))).hexdigest()
